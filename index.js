...
global.botname = process.env.BOT_NAME || "REDXBOT302";
global.themeemoji = "•";
    ...
    try {
        ...
        if (pairingCode && !isRegistered) {
            ...
            if (!!global.phoneNumber) {
                ...
                phoneNumberInput = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 61468259338 (without + or spaces) : `)));
            } else {
        ...
        sock.ev.on('connection.update', async (s) => {
            ...
            if (connection == "open") {
                ...
                // Start auto‑bio if plugin exists
                try {
                ...
                await delay(1999);
                console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'REDXBOT302'} ]`)}\n\n`));
                console.log(chalk.cyan(`< ================================================== >`));
                console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: @rootmindtech`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: AbdulRehman19721986`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner.join(', ')}`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: Abdul Rehman Rajpoot & Muzamil Khan`));
